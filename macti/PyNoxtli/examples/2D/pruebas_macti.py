...
# Datos del problema
#
longitud_x = 2.0 # meters
longitud_y = 1.0
TL = 100 # °C 
FT = 0   # Flujo a la derecha
FB = 0   # Flujo abajo
TR = 0  # °C
k  = 1 # W/m.K
...
placa.boundaryConditions(dirichlet = {'LEFT':TL, 'RIGHT':TR},
                         neumman   = {'BOTTOM':FB, 'TOP':FT, })
#
...
T[:,-1] = TR  # Condición de frontera pared superior
...
# Graficación
#
con = v.contourf(1,x,y,T,{'cmap':'inferno', 'levels':20})
v.colorbar(1, con)
v.show()
